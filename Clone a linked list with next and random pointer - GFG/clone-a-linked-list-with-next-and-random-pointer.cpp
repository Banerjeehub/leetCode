...
class Solution
{
    ...
    Node *copyList(Node *head)
    {
        ...
        //creating the map with the ptrs;
        while(temp)
        {
            original[originalHead] = temp;
            originalHead = originalHead->next;
            temp = temp->next;
        }
        
        //now we have to connect the random pointers in the clone list
        ...
        while(clone)
        {
            clone->arb = original[originalHead->arb];
            clone = clone->next;
            originalHead = originalHead->next;
        }
